...
<link rel="stylesheet" href="/loja_de_roupa/public/assets/src/style.css">
</head>
<body>
<div class="header">
...
<form method="post" action="index.php?controller=produto&action=salvar" enctype="multipart/form-
data">
